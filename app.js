...
const infoCard     = document.getElementById("infoCard"); // Bilgilendirme kutusu
...
btnRegister.addEventListener("click", async () => {
  ...
  try{
    ...
    regMsg.textContent = "Kayıt başarılı! Devam etmek için bilgileri okuyup onaylayın.";
...
// OTOMATİK GİRİŞİ KALDIRDIK -> Kullanıcı her zaman kayıt/giriş ekranını görebilecek
